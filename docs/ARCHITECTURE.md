...
| Samsung TCP inference hub | `frontend/android/app/src/main/java/com/quietcue/app/phone/` | Done; quantized YAMNet plus lazy Whisper ONNX on independent workers |
